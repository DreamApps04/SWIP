...
import 'ahorro_model.dart';
export 'ahorro_model.dart';
...
class AhorroWidget extends StatefulWidget {
  ...
  @override
  _AhorroWidgetState createState() => _AhorroWidgetState();
}

class _AhorroWidgetState extends State<AhorroWidget> {
  late AhorroModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AhorroModel());

    _model.txtNomAhorroController ??= TextEditingController();
    _model.txtNomAhorroFocusNode ??= FocusNode();

    _model.txtDescAhorroController ??= TextEditingController();
    _model.txtDescAhorroFocusNode ??= FocusNode();
                                      ...
                                      Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              controller:
                                                  _model.txtNomAhorroController,
                                              focusNode:
                                                  _model.txtNomAhorroFocusNode,
                                              autofocus: true,
                                              obscureText: false,
                                              ...
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium,
                                              validator: _model
                                                  .txtNomAhorroControllerValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                        ),
                                      ...
                                      Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                  .txtDescAhorroController,
                                              focusNode:
                                                  _model.txtDescAhorroFocusNode,
                                              autofocus: true,
                                              obscureText: false,
                                              decoration: InputDecoration(
                                                labelStyle:
                                              ...
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium,
                                              validator: _model
                                                  .txtDescAhorroControllerValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                        ),
